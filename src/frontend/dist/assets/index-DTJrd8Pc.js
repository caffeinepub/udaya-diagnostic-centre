...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        "data-ocid": "nav.panel",
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-card border-b border-border" : "bg-white/80 backdrop-blur-sm"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-primary-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-sm font-normal text-primary leading-none", children: "Udaya" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-widest leading-none mt-0.5", children: "Diagnostic Centre" })
                  ] })
                ]
              }
            ),
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-border shadow-card-hover", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col px-4 py-3 gap-1", children: [
            NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: link.href,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
        ...
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-white via-background/90 to-secondary/40" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-5 bg-accent/10 text-accent border-accent/30 font-semibold text-xs uppercase tracking-wider hover:bg-accent/10", children: "15+ Years of Trusted Service" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] leading-tight text-foreground mb-6", children: [
                "Udaya Diagnostic Centre",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-primary mt-1", children: "Trusted Diagnostic Services" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-normal text-2xl sm:text-3xl text-muted-foreground mt-2", children: "in Kalwakurthy" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-foreground/70 leading-relaxed mb-8 max-w-xl", children: "Accurate, reliable, and affordable laboratory testing for your health. With 15+ years of experience, we provide high-quality diagnostic services to help doctors and patients make the right medical decisions." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:9912505816", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mt-12", children: HERO_FEATURES.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-center text-foreground/80 leading-tight", children: label })
                  ]
                },
                label
              )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-4 bg-gradient-to-br from-primary/10 to-accent/10 rounded-3xl" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-5 -right-5 bg-primary text-primary-foreground rounded-2xl px-5 py-4 shadow-card-hover", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-display font-normal leading-none", children: "15+" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold opacity-80 mt-1", children: "Years Experience" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-muted text-muted-foreground border-border font-semibold text-xs uppercase tracking-wider", children: "About Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl text-foreground mb-5 leading-tight", children: [
                "Committed to Your",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground/70 leading-relaxed mb-4", children: [
                "Udaya Diagnostic Centre is managed by",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground font-semibold", children: "Mr. Udaya Balu" }),
                ", a certified laboratory technician with over 15 years of hands-on experience in diagnostic services."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground/70 leading-relaxed mb-8", children: [
                "Located in the heart of",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground font-semibold", children: "Kalwakurthy, Mahabubnagar, Telangana" }),
                ", we serve patients and healthcare providers with precise and timely laboratory results using modern equipment."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-muted text-muted-foreground border-border font-semibold text-xs uppercase tracking-wider", children: "What We Offer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl text-foreground mb-4", children: [
                "Our ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Services" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-lg mx-auto", children: "Comprehensive diagnostic services under one roof — accurate, timely, and affordable." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-6", children: SERVICES.map((service, idx) => {
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-primary" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-foreground", children: service.title })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: service.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "li",
                      {
                        className: "flex items-start gap-2 text-sm text-foreground/70",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-accent flex-shrink-0 mt-0.5" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-96 h-96 rounded-full bg-white/5 -translate-y-1/2 translate-x-1/3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-64 h-64 rounded-full bg-white/5 translate-y-1/2 -translate-x-1/3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-4 sm:px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-white/20 text-primary-foreground border-white/20 font-semibold text-xs uppercase tracking-wider", children: "Our Strengths" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl text-primary-foreground mb-4", children: "Why Choose Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 max-w-lg mx-auto", children: "We are dedicated to providing the highest standard of diagnostic care to our community." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: WHY_CHOOSE.map(({ icon: Icon2, label, desc }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition-colors border border-white/10${idx === 6 ? " sm:col-span-2 lg:col-span-1" : ""}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-primary-foreground" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-primary-foreground mb-2 text-base", children: label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm leading-relaxed", children: desc })
                  ]
                },
                label
              )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-muted text-muted-foreground border-border font-semibold text-xs uppercase tracking-wider", children: "Get in Touch" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl text-foreground mb-4", children: [
                "Contact ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Us" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-md mx-auto", children: "We are here to help. Reach out to us for appointments, test information, or any queries." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 bg-muted/50 rounded-2xl p-7 border border-border/60 flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-1.5", children: "Our Location" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground/70 text-sm leading-relaxed", children: [
                    "Udaya Diagnostic Centre",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-2xl p-7 border border-border/60 flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-1.5", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: "tel:9912505816",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-2xl p-7 border border-border/60 flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-1.5", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: "mailto:udayadiagnosticcentre3@gmail.com",
                      className: "text-primary hover:underline text-sm font-semibold break-all",
                      children: "udayadiagnosticcentre3@gmail.com"
                    }
                  )
                ] })
              ] })
                ...
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-5 h-5 text-pink-500" }),
                        "Follow on Instagram"
                      ]
                    }
                  )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-base leading-none", children: "Udaya Diagnostic Centre" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-60 mt-0.5", children: "Kalwakurthy, Mahabubnagar, Telangana" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-5 text-sm opacity-70", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            onClick: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs opacity-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Udaya Diagnostic Centre. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
